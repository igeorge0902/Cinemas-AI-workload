...
- **CID-XXX**: [Existing or new contract ID from `.ai/retrieval/references/CONTRACTS_INDEX.md`]
...
- [ ] Contract IDs are up to date in `.ai/retrieval/references/CONTRACTS_INDEX.md`.
